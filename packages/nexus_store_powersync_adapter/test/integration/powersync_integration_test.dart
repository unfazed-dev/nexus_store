...
void main() {
  group('PowerSync Integration Tests', () {
    ...
    group('Database Operations', skip: !isPowerSyncConfigured, () {
      test('creates and retrieves a record', () async {
      ...
      test('queries with pagination', () async {
        // TODO: Implement when PowerSync server is available
      }, skip: 'Requires PowerSync server',);
    });

    group('Sync Operations', skip: !isPowerSyncConfigured, () {
      test('syncs local changes to remote', () async {
        // TODO: Implement when PowerSync server is available
        //
      ...
      test('receives remote changes', () async {
        // TODO: Implement when PowerSync server is available
        //
    ...
    group('Offline/Online Transitions', skip: !isPowerSyncConfigured, () {
      test('queues changes while offline', () async {
        // TODO: Implement when PowerSync server is available
        //
      ...
      test('resumes sync after reconnection', () async {
        // TODO: Implement when PowerSync server is available
      }, skip: 'Requires PowerSync server',);

      test('handles partial sync interruption', () async {
        // TODO: Implement when PowerSync server is available
      }, skip: 'Requires PowerSync server',);
    });

    group('Watch Operations', skip: !isPowerSyncConfigured, () {
      test('watch emits changes for single record', () async {
        // TODO: Implement when PowerSync server is available
        //
      ...
      test('watchAll emits changes for collection', () async {
        // TODO: Implement when PowerSync server is available
      }, skip: 'Requires PowerSync server',);

      test('watchAll respects query filters', () async {
        // TODO: Implement when PowerSync server is available
      }, skip: 'Requires PowerSync server',);
    });

    group('Encrypted Backend', skip: !isPowerSyncConfigured, () {
      test('creates encrypted database', () async {
      ...
      test('rotates encryption key', () async {
        // TODO: Implement when powersync_sqlcipher is available
      }, skip: 'Requires powersync_sqlcipher',);

      test('data is not readable without key', () async {
        // TODO: Implement when powersync_sqlcipher is available
        //
