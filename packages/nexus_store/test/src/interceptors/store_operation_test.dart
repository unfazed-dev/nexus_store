...
void main() {
  group('StoreOperation', () {
    test('should have all expected operations', () {
      expect(StoreOperation.values, hasLength(20));
    ...
    test('should be iterable', () {
      ...
      expect(operations, hasLength(20));
    });
    ...
    test('should be usable in switch expressions', () {
      String categorize(StoreOperation op) {
        return switch (op) {
          ...
          StoreOperation.getOne =>
            'read',
          StoreOperation.watch || StoreOperation.watchAll => 'stream',
          StoreOperation.save ||
          StoreOperation.saveAll ||
          StoreOperation.updateWhere ||
          StoreOperation.patch ||
          StoreOperation.upsert ||
          StoreOperation.upsertAll =>
            'write',
          StoreOperation.delete ||
          StoreOperation.deleteAll ||
          ...
          StoreOperation.aggregate ||
          StoreOperation.exists ||
          StoreOperation.existsWhere =>
            'read',
        };
      }
